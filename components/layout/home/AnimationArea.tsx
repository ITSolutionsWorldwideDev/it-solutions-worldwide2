...
import LazyIndustriesCards from "./LazyIndustriesCards";
import LazyClientLogosSlider from "./LazyClientLogosSlider";
  ...
  return (
    <section className="relative z-10 w-full">
      ...
      <section className="pt-6 md:pt-10">
        <LazyIndustriesCards locale={locale} />
