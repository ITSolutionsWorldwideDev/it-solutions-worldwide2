// components/layout/banner-inquiry-section.tsx
...
type BannerInquirySectionProps = {
  slides: Slide[];
};

const BannerInquirySection: React.FC<BannerInquirySectionProps> = ({ slides }) => {
...
export default BannerInquirySection;
