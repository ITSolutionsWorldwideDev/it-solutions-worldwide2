      ...
      <section className="bg-white pt-16 pb-12 px-4">
        <div className="mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-10">
            Hire Virtual Assistants in the Netherlands Trusted by Businesses
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              What Your Virtual Assistant Can Help With
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto text-sm sm:text-base">
              Our dedicated virtual assistants are trained professionals who can
              support your business or personal workload immediately.
            </p>
          </div>
