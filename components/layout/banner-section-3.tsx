        ...
        <div className="relative w-full h-full  z-10 text-left text-white px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 w-full h-full ">
            <div className="relative  self-center">
              <h1 className="bg-gradient-to-r from-[#1A2980] to-[#26D0CE] bg-clip-text text-transparent font-lexend text-[84.636px] font-bold leading-[81.009px] uppercase">
                {slides[currentSlide].heading}
              </h1>
              {/* uppercase text-xl md:text-3xl lg:text-4xl font-bold mb-1 sm:mb-4 w-[90%] md:w-[90%] lg:w-1/2  */}
              <p className=" text-black font-lexend text-[61.395px] font-normal leading-[58.764px]">
              ...
              {slides[currentSlide].button ? (
                <div className=" gap-4 mt-2 inline-flex align-middle" >
                  <Link
                    ...
                    className={`transition px-4 py-2 rounded-[10px] bg-[#418F92]  text-base  flex-shrink-0 inline-flex align-middle leading-[50.37px] text-[16.79px]`}
                  >
                    {slides[currentSlide].button}
                    <Image
              ...
              {slides[currentSlide].button2 ? (
                <div className=" justify-start gap-4 mt-2 inline-flex align-middle ml-10">
                  <Link
                    href="#"
                    className={`bg-white transition px-4 py-2 rounded-[10px] border border-[#418F92] text-[#418F92]  flex-shrink-0 text-base leading-[50.37px] text-[16.79px] inline-flex align-middle hover:text-[#236B7A]`}
                  >
                    {slides[currentSlide].button2}
                    <Image
                      className="w-6 h-6 ml-2 self-center"
