...
export default async function Page({ params }: Props) {
  ...
  // console.log(translationPageKey);
  ...
  return (
    <div>
      ...
      <Roles roles={t(`${translationPageKey}.services_section`,{returnObjects:true}) as RolesData}/>
      ...
      <TrustSection />
      <Faqs
        faqData={t(`${translationPageKey}.faq.questions`,{returnObjects:true})}
      />
      <FullContentSection
